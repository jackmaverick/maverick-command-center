...
The Overview shows two lifetime channel-return cards from this same live job-profit response and the reviewed mailing-cost allocations. Revenue ROAS is invoiced revenue divided by documented mailing cost. Gross profit per $1 of mail spend is job gross profit to date divided by documented mailing cost; it does not subtract the mailing cost itself. Both cards show incomplete mailing-cost coverage and reconciled/provisional job counts so partial expenses or unfinished closeout cannot appear final.
